...
fsnap = h5py.File('snapshot_200.hdf5', 'r')
...
class InputFiles:
    ...
    def gasFile(self, file):
        ...
        np.savetxt('snap200_gasfile.txt', gas_skirt, delimiter=' ', header=header)
        self.gas.append(gas_skirt)
    ...
    def sourceFile(self, file):
        ...
        np.savetxt('snap200_srcex.txt', src_skirt, delimiter=' ', header=header)
        self.source.append(src_skirt)

x = InputFiles(fsnap)
x.gasFile(fsnap), x.sourceFile(fsnap)
x.gas, x.source